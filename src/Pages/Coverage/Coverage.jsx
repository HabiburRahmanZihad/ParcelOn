    ...
    return (
        <section className="bg-white py-12 px-4 md:px-12 lg:px-20 rounded-3xl">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-extrabold text-[#002E2E] mb-6 text-center md:text-left">
                ...
                >
                    <div className="relative w-full md:w-[600px]">
                        ...
                        <button
                            type="submit"
                            className="absolute right-1 top-1 bottom-1 px-6 bg-[#C6E137] hover:bg-[#b0cb2f] text-black font-semibold text-sm rounded-full transition-all"
                        >
                            Search
                        </button>
                    </div>
